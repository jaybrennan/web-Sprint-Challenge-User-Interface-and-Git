...
semantic HTML is a universally understood way for meaningfully marking up HTML. i.e. header, footer, section, nav, main

2. Name two big differences between ```display: block;``` and ```display: inline;```.

Display black will takeup an entire line horizontally, whereas display inline will allow other elements to be placed alongside it.
...
git allows us to have version control and to roll back changes if bugs are found / find out where bugs are introduced to the code.
